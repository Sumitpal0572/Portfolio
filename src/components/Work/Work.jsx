    ...
    >
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80 p-4">
          <div className="bg-gray-900 rounded-xl shadow-2xl w-[90%] max-w-2xl max-h-[85vh] overflow-y-auto relative">
            ...
            <div className="flex flex-col items-center">
              <div className="w-full flex  bg-gray-900 px-4">
                <img
              ...
              <div className="lg:p-8 p-6">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="w-1/2 bg-gray-400 hover:bg-purple-800 text-gray-400 lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-xl text-sm font-semibold text-center"
                  >
                    View Code
                  </a>
                  <a
